...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .brand h1 { font-size: 22px; font-weight: 700; color: #4b2bb2; }
        .title { font-size: 20px; font-weight: 700; margin-bottom: 8px; }
        .subtitle { color: #5b5b5b; margin-bottom: 24px; font-size: 14px; }
        ...
        .actions a { color: #7C4DFF; text-decoration: none; font-weight: 600; }
        ...
        button[type="submit"]:hover { box-shadow: 0 10px 24px rgba(124, 77, 255, 0.35); }
        button[type="submit"]:active { transform: translateY(1px); }
        .footer { text-align: center; margin-top: 16px; font-size: 14px; color: #555; }
        .footer a { color: #7C4DFF; font-weight: 600; text-decoration: none; }
...
<body>
    <div class="container">
        ...
        <div class="card">
            ...
            <p class="footer">Belum punya akun? <a href="{{ url('/register') }}">Daftar sekarang</a></p>
        </div>
    </div>
    <script>
